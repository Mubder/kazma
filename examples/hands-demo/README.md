...
4. Approve the HITL card (`file_apply_patch_set`). Nearby pytest runs **as part of that tool** (`verify=true`). The result must contain `TESTS PASSED`.
5. If you still want to confirm: `pytest test_app.py` here.
