...
- **tools**: mcp_test_server — agent-facing MCP diagnostics tool

## v0.6.7 (2026-08-09)

### Fix

- **alerts**: health watchdog false positive on healthy memory

## v0.6.6 (2026-08-09)

### Fix

- **audit**: full-repo remediation — security, memory, tools, MCP, alerts
