...
class ArabicTantivyTokenizer:
    ...
    def _load_stop_words(self) -> set[str]:
        ...
        return {
            ...
            "التي", "الذي", "أن", "كان", "هو", "هي", "لا", "ما",
            "لم", "لن", "قد", "كان", "يكون", "تكون", "كانت", "كانوا",

            # Pronouns
            "أنا", "أنت", "أنتِ", "هو", "هي", "نحن", "أنتم", "هم", "هن",
            "إياي", "إياك", "إياكِ", "إياه", "إياها", "إيانا", "إياكم", "إياهم",

            # Demonstratives
            "ذلك", "تلك", "هؤلاء", "هذا", "هذه", "هذان", "هاتان",

            # Prepositions
            "حتى", "منذ", "خلال", "دون", "بعد", "قبل", "تحت", "فوق",
            "أمام", "خلف", "بين", "نحو", "عبر", "حول", "ضد",

            # Conjunctions
            "و", "ف", "ثم", "أو", "أم", "بل", "لكن", "غير",
            "إلا", "سوى", "لولا", "لوما", "عل", "كي", "لما",

            # Relative pronouns
            "الذي", "التي", "الذين", "اللذين", "اللتين", "اللواتي",

            # Interrogatives
            "من", "ما", "متى", "أين", "كيف", "لماذا", "كم", "أي",

            # Common verbs (auxiliary)
            "ليس", "ليست", "ليسوا", "ليسن", "ما", "لا", "لم", "لن",

            # Numbers (as words)
            "واحد", "اثنان", "ثلاثة", "أربعة", "خمسة",

            # Other common words
            "بل", "بلى", "إذا", "إذ", "حين", "وقت", "مرة",
            "بعض", "كل", "جميع", "أجمع", "كافة", "عموم",
        }
