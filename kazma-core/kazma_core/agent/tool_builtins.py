"""Built-in LocalToolRegistry tools (extracted from tool_registry).

Registration is a side effect of :func:`register_builtin_tools`. The HITL
execute chokepoint stays in ``tool_registry.py``.
"""
