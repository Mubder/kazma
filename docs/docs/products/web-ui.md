...
| Entities | Rename display labels, merge/link shells, delete empty, **click row → focus graph**. Pagination + diacritic-insensitive/alias-aware search. Inspect: **Group under** / **Ungroup** (view-only) |
