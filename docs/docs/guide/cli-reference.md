...
description: Kazma CLI Reference — code-audited reference (unified docs, v0.11+)
---
...
| `kazma hub sign &lt;path> [--secret]` | **HMAC-SHA256 sign** the entry-point `.py` into the manifest. Requires `KAZMA_SECRET`. See [Skills, MCP & Tools](skills-mcp-and-tools#cryptographic-signing). |
