...
**Status:** Implemented (core + polish + Settings UI + browser OAuth + IMAP/POP modes + scope validation) — see `email-manager` native skill, `/api/email/*`, [Email integration guide](../docs/guide/email-integration.md)  
