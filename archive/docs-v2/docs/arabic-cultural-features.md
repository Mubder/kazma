...
`kazma-memory/kazma_memory/arabic_tokenizer.py` (292 lines). Detailed in [Memory & RAG → Arabic tokenizer](memory-and-rag.md#5-the-arabic-tokenizer). Summary of the normalization pipeline (`normalize`, lines 132-165):
