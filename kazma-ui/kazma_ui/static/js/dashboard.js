...
(function() {
  ...
  function initFeatureCards() {
    ...
    var svgIcons = {
      ...
      x: '<svg width="20" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2H21.5l-7.5 8.57L22.5 22h-6.59l-5.16-6.74L4.8 22H1.5l8.02-9.16L1.5 2h6.75l4.66 6.18L18.244 2zm-1.16 18.06h1.82L7 3.84H5.05l12.03 16.22z"/></svg>',
    ...
    var fallback = [
      ...
      { id: 'x', name: 'X publisher', desc: 'Official X API v2; always-on HITL', color: '#e7e9ea' },
