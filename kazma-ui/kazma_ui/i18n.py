...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "nav.scheduled": {"en": "Scheduled", "ar": "المهام المجدولة"},
    ...
    "memory.open_console": {"en": "Open Memory console", "ar": "فتح وحدة الذاكرة"},
    "memory.tab_beliefs": {"en": "Beliefs", "ar": "المعتقدات"},
    "memory.tab_entities": {"en": "Entities", "ar": "الكيانات"},
    "memory.tab_merges": {"en": "Pending merges", "ar": "عمليات الدمج المعلقة"},
    "memory.tab_hygiene": {"en": "Hygiene", "ar": "التنظيف"},
    "memory.tab_console": {"en": "Graph & health", "ar": "الرسم والصحة"},
    "memory.refresh": {"en": "Refresh", "ar": "تحديث"},
    "memory.search": {"en": "Search", "ar": "بحث"},
    "memory.invalidate": {"en": "Invalidate", "ar": "إبطال"},
    "memory.delete": {"en": "Delete", "ar": "حذف"},
    "memory.merge": {"en": "Merge source → target", "ar": "دمج المصدر ← الهدف"},
    "memory.link": {"en": "Link source —pred→ target", "ar": "ربط المصدر ← الهدف"},
    "memory.unlink": {"en": "Unlink", "ar": "فك الربط"},
    "memory.edit": {"en": "Edit", "ar": "تعديل"},
    "memory.rename": {"en": "Rename", "ar": "إعادة تسمية"},
    "memory.empty_only": {"en": "Empty only", "ar": "الفارغة فقط"},
    "memory.isolated_only": {"en": "Isolated only", "ar": "المعزولة فقط"},
    "memory.purge_empty": {"en": "Purge empty entity shells", "ar": "حذف كيانات فارغة"},
    "memory.dedupe_noted": {"en": "Invalidate near-dup noted", "ar": "إبطال ملاحظات مكررة"},
    "memory.archive_dead": {"en": "Archive invalidated beliefs", "ar": "أرشفة المعتقدات الملغاة"},
    "memory.run_hygiene": {"en": "Run selected hygiene", "ar": "تشغيل التنظيف"},
    "memory.source": {"en": "Source", "ar": "المصدر"},
    "memory.target": {"en": "Target", "ar": "الهدف"},
    "memory.predicate": {"en": "Predicate (link)", "ar": "العلاقة (رابط)"},
    "memory.no_rows": {"en": "No rows", "ar": "لا صفوف"},
    "memory.confirm_invalidate": {"en": "Soft-invalidate this belief?", "ar": "إبطال هذا المعتقد؟"},
    "memory.confirm_delete": {"en": "Delete this entity shell?", "ar": "حذف هذا الكيان؟"},
    "memory.confirm_merge": {"en": "Merge source into target? Beliefs will be rewired.", "ar": "دمج المصدر في الهدف؟"},
    "memory.confirm_hygiene": {"en": "Run the selected hygiene actions?", "ar": "تشغيل إجراءات التنظيف المحددة؟"},
    ...
    "knowledge.title": {"en": "Knowledge Library", "ar": "المكتبة المعرفية"},
    "knowledge.intro": {
    ...
    "knowledge.add_title": {"en": "Add a library", "ar": "إضافة مكتبة"},
    "knowledge.id_placeholder": {"en": "Library ID (slug, e.g. shipx_whatsapp_api)", "ar": "معرّف المكتبة (مثل shipx_whatsapp_api)"},
    "knowledge.name_placeholder": {"en": "Display name", "ar": "الاسم المعروض"},
    ...
    "knowledge.crawl_tree": {"en": "Crawl whole doc tree", "ar": "زحف لشجرة التوثيق كاملة"},
    ...
    "knowledge.libraries": {"en": "Libraries", "ar": "المكتبات"},
    "knowledge.refresh": {"en": "↻ Refresh", "ar": "↻ تحديث"},
    "knowledge.empty": {
    ...
    "knowledge.chunks": {"en": "chunks", "ar": "مقطع"},
    "knowledge.auto_inject": {"en": "auto-inject", "ar": "حقن تلقائي"},
    "knowledge.test": {"en": "Test", "ar": "اختبار"},
    "knowledge.refresh_lib": {"en": "↻ Refresh", "ar": "↻ تحديث"},
    "knowledge.browse": {"en": "Browse", "ar": "استعراض"},
    "knowledge.delete": {"en": "Delete", "ar": "حذف"},
    "knowledge.search_placeholder": {"en": "Ask something about this corpus…", "ar": "اسأل شيئًا عن هذا المحتوى…"},
    "knowledge.search_btn": {"en": "Search", "ar": "بحث"},
    "knowledge.searching": {"en": "searching…", "ar": "يبحث…"},
    "knowledge.delete_confirm_title": {"en": "Delete \"{name}\"?", "ar": "حذف \"{name}\"؟"},
    ...
    "knowledge.archive": {"en": "Archive", "ar": "أرشفة"},
    "knowledge.unarchive": {"en": "Restore", "ar": "استعادة"},
    "knowledge.archived_msg": {"en": "Library archived.", "ar": "تمت أرشفة المكتبة."},
    "knowledge.restored_msg": {"en": "Library restored.", "ar": "تمت استعادة المكتبة."},
    "knowledge.tab_active": {"en": "Active", "ar": "نشطة"},
    "knowledge.tab_archived": {"en": "Archived", "ar": "مؤرشفة"},
    ...
    "research.start_title": {"en": "Start deep research", "ar": "بدء بحث عميق"},
    "research.topic_label": {"en": "Topic", "ar": "الموضوع"},
    "research.topic_placeholder": {"en": "e.g. Python GIL evolution and free-threading", "ar": "مثال: تطور GIL في بايثون والتحرير من الخيوط"},
    "research.depth_label": {"en": "Depth", "ar": "العمق"},
    "research.depth_deep": {"en": "Deep", "ar": "عميق"},
    "research.depth_brief": {"en": "Brief", "ar": "مختصر"},
    "research.sources_label": {"en": "Max sources", "ar": "أقصى مصادر"},
    "research.start_btn": {"en": "Start", "ar": "ابدأ"},
    "research.start_running": {"en": "Research running…", "ar": "البحث جارٍ…"},
    ...
    "replay.about_title": {"en": "Time Travel Replay", "ar": "السفر عبر الزمن"},
    ...
    "research.about_desc": {"en": "Deep research runs from this panel (or chat / <code>/research deep</code>) produce multi-source reports. Swarm research tasks also land here with full traceability:", "ar": "تشغيلات البحث العميق من هذه اللوحة (أو المحادثة / <code>/research deep</code>) تنتج تقارير متعددة المصادر. مهام بحث السرب تظهر هنا أيضاً بكامل قابلية التتبع:"},
    "research.about_browse": {"en": "<strong>Browse</strong> pipeline papers, live sessions, and swarm research outputs.", "ar": "<strong>تصفّح</strong> أوراق المسار والجلسات الحية ومخرجات بحث السرب."},
    "research.about_compare": {"en": "<strong>Compare</strong> two swarm runs side-by-side — cost, tokens, duration, and output text.", "ar": "<strong>قارن</strong> تشغيلتي سرب جنباً إلى جنب — التكلفة والرموز والمدة ونص المخرج."},
    ...
    "research.about_note": {"en": "Deep sessions: <code>kazma-data/research_sessions.db</code> + reports under <code>research/reports/</code>. Swarm tasks: <code>metadata.kind=research</code> in TaskStore.", "ar": "الجلسات العميقة: <code>kazma-data/research_sessions.db</code> + التقارير تحت <code>research/reports/</code>. مهام السرب: <code>metadata.kind=research</code> في TaskStore."},
    ...
    "chat.reasoning": {"en": "Reasoning", "ar": "الاستدلال"},
    "chat.phase_think": {"en": "Think", "ar": "فكر"},
    "chat.phase_act": {"en": "Act", "ar": "نفّذ"},
    "chat.phase_write": {"en": "Write", "ar": "اكتب"},
    "chat.working": {"en": "Working…", "ar": "جارٍ العمل…"},
    "chat.plan": {"en": "Plan", "ar": "الخطة"},
    "chat.step": {"en": "step", "ar": "خطوة"},
    "chat.steps": {"en": "steps", "ar": "خطوات"},
    "chat.done": {"en": "Done", "ar": "تم"},
    ...
    "chat.plan_locked": {"en": "Plan locked ({n} steps)", "ar": "تم قفل الخطة ({n} خطوات)"},
    "chat.plan_progress": {"en": "plan {done}/{total}", "ar": "الخطة {done}/{total}"},
    "chat.thinking_queue": {
    ...
    "dashboard.cap.x": {"en": "X publisher", "ar": "ناشر إكس"},
    ...
    "dashboard.hitl_approving": {"en": "Approving…", "ar": "جاري الموافقة…"},
    "dashboard.hitl_denying": {"en": "Denying…", "ar": "جاري الرفض…"},
    "dashboard.hitl_running": {"en": "Running approved tool…", "ar": "تشغيل الأداة المعتمدة…"},
    "dashboard.hitl_stream_unavailable": {"en": "Streaming unavailable", "ar": "البث غير متاح"},
    "dashboard.hitl_executing": {"en": "Executing tool: {name}…", "ar": "تنفيذ الأداة: {name}…"},
    "dashboard.hitl_approved": {"en": "Approved — complete", "ar": "تمت الموافقة"},
    "dashboard.hitl_denied": {"en": "Denied", "ar": "مرفوض"},
    "dashboard.hitl_dismiss": {"en": "Dismiss", "ar": "إغلاق"},
    ...
    "settings.tab_embedder": {"en": "Embedder", "ar": "المُضمِّن"},
    ...
    "settings.offsite_provider_select": {"en": "Select a provider", "ar": "اختر مزوداً"},
    "settings.offsite_remote": {"en": "Remote Path", "ar": "المسار البعيد"},
    "settings.offsite_remote_hint": {"en": "Format: remote-name:folder (e.g. kazma-backup:kazma-backups)", "ar": "التنسيق: اسم-البعيد:المجلد (مثال: kazma-backup:kazma-backups)"},
    "settings.offsite_enabled": {"en": "Enable offsite sync after each backup", "ar": "تفعيل المزامنة الخارجية بعد كل نسخة احتياطية"},
    "settings.offsite_test": {"en": "Test Connection", "ar": "اختبار الاتصال"},
    "settings.offsite_save": {"en": "Save", "ar": "حفظ"},
    "settings.offsite_saved": {"en": "Offsite backup configuration saved.", "ar": "تم حفظ إعدادات النسخ الاحتياطي الخارجي."},
    ...
    "settings.tab_x": {"en": "X", "ar": "إكس"},
    "settings.x_title": {"en": "X (official API)", "ar": "إكس (واجهة رسمية)"},
    "settings.x_subtitle": {
    ...
    "settings.x_refresh": {"en": "Refresh", "ar": "تحديث"},
    "settings.x_status": {"en": "Status", "ar": "الحالة"},
    "settings.x_configured": {"en": "Keys stored", "ar": "المفاتيح محفوظة"},
    "settings.x_not_configured": {"en": "Not configured", "ar": "غير مُعدّ"},
    ...
    "settings.x_api_key_secret": {"en": "API Key Secret", "ar": "سر مفتاح API"},
    "settings.x_access_token": {"en": "Access Token", "ar": "رمز الوصول"},
    "settings.x_access_token_secret": {"en": "Access Token Secret", "ar": "سر رمز الوصول"},
    "settings.x_show_keys": {"en": "Show values while typing", "ar": "إظهار القيم أثناء الكتابة"},
    "settings.x_enabled": {"en": "Enable posting (after keys are saved)", "ar": "تفعيل النشر (بعد حفظ المفاتيح)"},
    "settings.x_max_day": {"en": "Max posts per day (Kazma cap)", "ar": "أقصى تغريدات في اليوم"},
    "settings.x_max_month": {"en": "Max posts per 30 days", "ar": "أقصى تغريدات في 30 يوماً"},
    "settings.x_save": {"en": "Save keys", "ar": "حفظ المفاتيح"},
    "settings.x_test": {"en": "Test (users/me)", "ar": "اختبار (users/me)"},
    "settings.x_disconnect": {"en": "Disconnect", "ar": "قطع الاتصال"},
    "settings.x_howto": {
    ...
    "settings.x_audit_text": {"en": "Post text", "ar": "نص المنشور"},
    "settings.x_audit_status": {"en": "Status", "ar": "الحالة"},
    "settings.x_audit_tweet": {"en": "Tweet", "ar": "التغريدة"},
    ...
    "scheduled.title": {"en": "Scheduled Tasks", "ar": "المهام المجدولة"},
    "scheduled.hint": {
    ...
    "scheduled.refresh": {"en": "Refresh", "ar": "تحديث"},
    "scheduled.new_task": {"en": "New task", "ar": "مهمة جديدة"},
    "scheduled.new_x": {"en": "New X post", "ar": "منشور إكس جديد"},
    "scheduled.edit_task": {"en": "Edit task", "ar": "تعديل المهمة"},
    "scheduled.edit_x": {"en": "Reschedule X post", "ar": "إعادة جدولة منشور إكس"},
    "scheduled.when": {"en": "When", "ar": "الوقت"},
    "scheduled.type": {"en": "Type", "ar": "النوع"},
    "scheduled.summary": {"en": "Details", "ar": "التفاصيل"},
    "scheduled.status": {"en": "Status", "ar": "الحالة"},
    "scheduled.actions": {"en": "Actions", "ar": "إجراءات"},
    "scheduled.edit": {"en": "Edit", "ar": "تعديل"},
    "scheduled.delete": {"en": "Delete", "ar": "حذف"},
    "scheduled.save": {"en": "Save", "ar": "حفظ"},
    "scheduled.cancel": {"en": "Cancel", "ar": "إلغاء"},
    "scheduled.prompt": {"en": "Task prompt", "ar": "نص المهمة"},
    "scheduled.prompt_ph": {"en": "What should the agent do at the scheduled time?", "ar": "ماذا يجب أن يفعل الوكيل في الوقت المحدد؟"},
    "scheduled.timing": {"en": "When", "ar": "الوقت"},
    "scheduled.timing_ph": {"en": "e.g. 5m, 1h, daily at 9am, or 2026-12-01T09:00", "ar": "مثال: 5m أو 1h أو daily at 9am أو 2026-12-01T09:00"},
    ...
    "scheduled.x_text": {"en": "Post text", "ar": "نص المنشور"},
    "scheduled.x_text_ph": {"en": "The exact tweet to publish", "ar": "التغريدة التي ستنشر كما هي"},
    ...
    # ── overview + tabs (2026-08-29 redesign) ──
    ...
    "scheduled.stat_done": {"en": "Completed", "ar": "منتهية"},
    "scheduled.tab_upcoming": {"en": "Upcoming", "ar": "القادمة"},
    "scheduled.tab_history": {"en": "History", "ar": "السجل"},
    "scheduled.tab_x_activity": {"en": "X activity", "ar": "نشاط إكس"},
    "scheduled.overdue": {"en": "Overdue", "ar": "متأخرة"},
    "scheduled.kind_task": {"en": "Task", "ar": "مهمة"},
    "scheduled.kind_x": {"en": "X post", "ar": "منشور إكس"},
    ...
    "scheduled.st_pending": {"en": "Pending", "ar": "قيد الانتظار"},
    "scheduled.st_running": {"en": "Running", "ar": "قيد التنفيذ"},
    "scheduled.st_done": {"en": "Done", "ar": "تم"},
    "scheduled.st_fired": {"en": "Posted", "ar": "تم النشر"},
    "scheduled.st_failed": {"en": "Failed", "ar": "فشل"},
    "scheduled.st_cancelled": {"en": "Cancelled", "ar": "ملغاة"},
    "scheduled.created": {"en": "Task scheduled.", "ar": "تمت جدولة المهمة."},
    "scheduled.updated": {"en": "Saved.", "ar": "تم الحفظ."},
    "scheduled.deleted": {"en": "Deleted.", "ar": "تم الحذف."},
    "scheduled.x_booked": {"en": "X post scheduled.", "ar": "تمت جدولة منشور إكس."},
    "scheduled.prompt_required": {"en": "Task prompt is required.", "ar": "نص المهمة مطلوب."},
    "scheduled.timing_required": {"en": "A time is required.", "ar": "الوقت مطلوب."},
    "scheduled.x_text_required": {"en": "Post text is required.", "ar": "نص المنشور مطلوب."},
    ...
    "settings.embedder_model": {"en": "Model", "ar": "النموذج"},
    "settings.embedder_dim": {"en": "Dimension", "ar": "البُعد"},
    "settings.embedder_provider": {"en": "Provider", "ar": "المزود"},
    "settings.embedder_active_class": {"en": "Active backend", "ar": "الواجهة النشطة"},
    "settings.embedder_restart_needed": {"en": "Restart required", "ar": "إعادة تشغيل مطلوبة"},
    ...
    "settings.embedder_config_title": {"en": "Configuration", "ar": "الإعدادات"},
    "settings.embedder_provider_local": {"en": "Local (sentence-transformers)", "ar": "محلي (sentence-transformers)"},
    "settings.embedder_provider_remote": {"en": "OpenAI-compatible API", "ar": "واجهة برمجية متوافقة مع OpenAI"},
    ...
    "settings.embedder_model_custom": {"en": "Custom model…", "ar": "نموذج مخصص…"},
    "settings.embedder_custom_model": {"en": "Model name", "ar": "اسم النموذج"},
    ...
    "settings.embedder_base_url": {"en": "Base URL", "ar": "الرابط الأساسي"},
    "settings.embedder_api_key_env": {"en": "API key env var", "ar": "متغير بيئة مفتاح API"},
    ...
    "settings.embedder_save": {"en": "Save embedder settings", "ar": "حفظ إعدادات المُضمِّن"},
    "settings.embedder_restart_btn": {"en": "Restart server", "ar": "إعادة تشغيل الخادم"},
    "settings.embedder_db_title": {"en": "Memory vector-space composition", "ar": "تركيبة فضاء المتجهات في الذاكرة"},
    ...
    "settings.embedder_db_version": {"en": "Model version", "ar": "إصدار النموذج"},
    "settings.embedder_db_episodes": {"en": "Episodes", "ar": "الأحداث"},
    "settings.embedder_db_beliefs": {"en": "Beliefs", "ar": "المعتقدات"},
    "settings.embedder_db_empty": {"en": "No memory rows yet.", "ar": "لا توجد صفوف ذاكرة بعد."},
    ...
    "settings.embedder_rebuild_btn": {"en": "Rebuild embeddings", "ar": "إعادة بناء التضمينات"},
    "settings.embedder_rebuild_running": {"en": "Rebuilding…", "ar": "جارٍ إعادة البناء…"},
    "settings.embedder_rebuild_done": {"en": "Rebuild complete", "ar": "اكتملت إعادة البناء"},
    "settings.embedder_rebuild_error": {"en": "Rebuild failed", "ar": "فشلت إعادة البناء"},
    "settings.embedder_manual_title": {"en": "Manual fallback", "ar": "بديل يدوي"},
 ...
 "settings.webhooks": {"en": "Webhooks", "ar": "الويب هوك"},
    ...
    "settings.conflicts_detected": {"en": "Conflicts Detected", "ar": "تم اكتشاف تعارضات"},
    ...
    "settings.logging_title": {"en": "Logging", "ar": "تسجيل الدخول"},
    "settings.logging_level": {"en": "Log Level", "ar": "مستوى السجل"},
    ...
    "settings.save_logging": {"en": "Save Logging", "ar": "حفظ إعدادات السجل"},
    "settings.proxy_title": {"en": "Proxy Provider", "ar": "مزود البروكسي"},
    "settings.proxy_hint": {
    ...
    "settings.proxy_provider": {"en": "Provider", "ar": "المزود"},
    "settings.proxy_none": {"en": "None (direct)", "ar": "لا شيء (مباشر)"},
    "settings.proxy_host": {"en": "Host", "ar": "المضيف"},
    "settings.proxy_port": {"en": "Port", "ar": "المنفذ"},
    "settings.proxy_username": {"en": "Username", "ar": "اسم المستخدم"},
    "settings.proxy_password": {"en": "Password", "ar": "كلمة المرور"},
    "settings.proxy_network": {"en": "Network type", "ar": "نوع الشبكة"},
    "settings.proxy_network_mixed": {"en": "Mixed", "ar": "مختلط"},
    "settings.proxy_network_residential": {"en": "Residential", "ar": "سكني"},
    "settings.proxy_network_mobile": {"en": "Mobile", "ar": "محمول"},
    "settings.proxy_country": {"en": "Country (optional)", "ar": "الدولة (اختياري)"},
    "settings.proxy_sticky": {
        "en": "Sticky session (same IP across requests)",
        "ar": "جلسة ثابتة (نفس IP عبر الطلبات)",
    },
    "settings.proxy_save": {"en": "Save Proxy", "ar": "حفظ البروكسي"},
    "settings.proxy_test": {"en": "Test Connection", "ar": "اختبار الاتصال"},
    "settings.proxy_exit_ip": {"en": "Exit IP", "ar": "IP الخروج"},
    "settings.proxy_saved": {"en": "Proxy settings saved", "ar": "تم حفظ إعدادات البروكسي"},
    ...
    "settings.system_reset": {"en": "System Reset", "ar": "إعادة تعيين النظام"},
    ...
    "swarm.tab_templates": {"en": "Templates", "ar": "القوالب"},
    "swarm.templates_title": {"en": "Worker Templates", "ar": "قوالب العمال"},
    ...
    "swarm.add_template": {"en": "Add Template", "ar": "إضافة قالب"},
    "swarm.edit_template": {"en": "Edit Template", "ar": "تحرير القالب"},
    "swarm.no_templates": {"en": "No templates defined. Workers won't auto-spawn until you add one.", "ar": "لا توجد قوالب معرفة. لن يتم إنشاء العمال تلقائيًا حتى تضيف قالبًا."},
    "swarm.templates_load_failed": {"en": "Failed to load templates", "ar": "فشل تحميل القوالب"},
    "swarm.reap_idle": {"en": "Reap Idle", "ar": "إزالة الخامل"},
    "swarm.reaped": {"en": "Reaped", "ar": "تمت الإزالة"},
    "swarm.instances": {"en": "active", "ar": "نشط"},
    "swarm.model_auto": {"en": "auto (best available)", "ar": "تلقائي (الأفضل المتاح)"},
    "swarm.tmpl_name": {"en": "Name", "ar": "الاسم"},
    "swarm.tmpl_name_required": {"en": "Template name is required", "ar": "اسم القالب مطلوب"},
    "swarm.tmpl_role": {"en": "Role", "ar": "الدور"},
    "swarm.tmpl_expertise": {"en": "Expertise tags", "ar": "وسوم الخبرة"},
    ...
    "swarm.tmpl_model": {"en": "Model", "ar": "النموذج"},
    ...
    "swarm.tmpl_max_instances": {"en": "Max instances", "ar": "أقصى عدد"},
    "swarm.tmpl_system_prompt": {"en": "System prompt (Soul)", "ar": "موجه النظام (الروح)"},
    "swarm.tmpl_prompt_ph": {"en": "You are a specialist worker…", "ar": "أنت عامل متخصص…"},
    "swarm.save_template": {"en": "Save Template", "ar": "حفظ القالب"},
    "swarm.reset": {"en": "Reset", "ar": "إعادة تعيين"},
    "swarm.template_saved": {"en": "Template saved", "ar": "تم حفظ القالب"},
    "swarm.template_deleted": {"en": "Template deleted", "ar": "تم حذف القالب"},
    "swarm.save_failed": {"en": "Save failed", "ar": "فشل الحفظ"},
 ...
 "swarm.results.dispatch": {"en": "Dispatch", "ar": "إرسال"},
    ...
    # Research / knowledge / pipeline tools (names stay English)
    "tool.desc.read_url_to_file": {"en": "Fetch a URL and save the full extract under the workspace.", "ar": "جلب رابط وحفظ النص الكامل داخل مساحة العمل."},
    "tool.desc.list_research_chunks": {"en": "List chunk indices and previews for a saved research file.", "ar": "سرد فهارس المقاطع ومعايناتها لملف بحث محفوظ."},
    "tool.desc.read_research_chunk": {"en": "Read one chunk of a saved research file.", "ar": "قراءة مقطع واحد من ملف بحث محفوظ."},
    "tool.desc.summarize_research_file": {"en": "Light extractive outline of a research file.", "ar": "مخطط استخراجي خفيف لملف بحث."},
    "tool.desc.digest_research_file": {"en": "Walk all chunks and return a bounded extractive digest.", "ar": "المرور على كل المقاطع وإرجاع ملخص استخراجي محدود."},
    "tool.desc.synthesize_from_digests": {"en": "LLM multi-source synthesis from saved research digests.", "ar": "توليف متعدد المصادر بالذكاء الاصطناعي من ملخصات البحث."},
    "tool.desc.run_research_pipeline": {"en": "Deep research pipeline: search, acquire, digest, synthesize, report.", "ar": "مسار بحث عميق: بحث، جلب صفحات، تلخيص، توليف، تقرير."},
    "tool.desc.crawl_site": {"en": "Bounded multi-page crawl of a documentation site.", "ar": "زحف محدود متعدد الصفحات لموقع وثائق."},
    "tool.desc.knowledge_list_libraries": {"en": "List knowledge libraries and chunk counts.", "ar": "سرد مكتبات المعرفة وعدد المقاطع."},
    "tool.desc.knowledge_create_library": {"en": "Create a knowledge library for doc ingestion.", "ar": "إنشاء مكتبة معرفة لاستيعاب الوثائق."},
    "tool.desc.knowledge_ingest_url": {"en": "Ingest one URL into a knowledge library.", "ar": "استيعاب رابط واحد في مكتبة معرفة."},
    "tool.desc.knowledge_ingest_site": {"en": "Crawl and ingest a doc tree into a knowledge library.", "ar": "زحف شجرة وثائق واستيعابها في مكتبة معرفة."},
    "tool.desc.knowledge_search": {"en": "Search ingested knowledge libraries with citations.", "ar": "البحث في مكتبات المعرفة المستوعَبة مع الاستشهاد بالمصادر."},
    "tool.desc.dispatch_swarm": {"en": "Dispatch a research or analysis task to the swarm.", "ar": "إرسال مهمة بحث أو تحليل إلى السرب."},
    "tool.desc.check_swarm_task": {"en": "Check status or result of a swarm task.", "ar": "التحقق من حالة أو نتيجة مهمة سرب."},
    "tool.desc.file_delete": {"en": "Delete a file inside the workspace.", "ar": "حذف ملف داخل مساحة العمل."},
    "tool.desc.code_exec": {"en": "Execute code in a sandboxed environment.", "ar": "تنفيذ كود في بيئة معزولة."},
    "tool.desc.install_agent_skill": {"en": "Install an Agent Skill from GitHub.", "ar": "تثبيت مهارة وكيل من GitHub."},
    "tool.desc.uninstall_agent_skill": {"en": "Uninstall an Agent Skill.", "ar": "إزالة مهارة وكيل."},

    # ── Skills page ────────────────────────────────────────────────
    "skills.title": {"en": "Skills", "ar": "المهارات"},
    "skills.tab_installed": {"en": "Installed", "ar": "المثبتة"},
    "skills.tab_hub": {"en": "Hub Browse", "ar": "تصفح المركز"},
    "skills.tab_marketplace": {"en": "Marketplace", "ar": "السوق"},
    "skills.marketplace_heading": {"en": "Open Agent Skills Marketplace", "ar": "سوق المهارات المفتوح"},
    "skills.marketplace_hint": {"en": "Search the public ecosystem (GitHub topic:agent-skills) and install in one click. Review a repo's SKILL.md before installing.", "ar": "ابحث في المنظومة العامة (GitHub topic:agent-skills) وثبّت بنقرة واحدة. راجع ملف SKILL.md قبل التثبيت."},
    "skills.marketplace_ph": {"en": "Search skills (e.g. react, design, testing)…", "ar": "ابحث عن مهارات (مثل react، تصميم، اختبار)…"},
    "skills.marketplace_empty": {"en": "No matching skills found. Try broader terms.", "ar": "لا توجد مهارات مطابقة. جرّب كلمات أعم."},
    ...
    "skills.installing": {"en": "Installing…", "ar": "جاري التثبيت…"},
    "skills.install_skill": {"en": "Install Skill", "ar": "تثبيت مهارة"},
    "skills.install_heading": {"en": "Install from agentskills.io / GitHub", "ar": "تثبيت من agentskills.io / GitHub"},
    "skills.install_hint": {"en": "Paste owner/repo or a GitHub URL (e.g. shadcn/improve). Uses the open Agent Skills format — no Node/npm required.", "ar": "الصق owner/repo أو رابط GitHub (مثل shadcn/improve). يستخدم صيغة Agent Skills المفتوحة — بدون Node/npm."},
    "skills.install_ph": {"en": "shadcn/improve or https://github.com/shadcn/improve", "ar": "shadcn/improve أو https://github.com/shadcn/improve"},
    ...
    "research.open_md": {"en": "Open report", "ar": "فتح التقرير"},
    "research_no_results": {"en": "No research results yet.", "ar": "لا توجد نتائج بحث بعد."},
    "research_no_archived": {"en": "No archived research.", "ar": "لا يوجد بحث مؤرشف."},
    ...
    "mcp.field_url": {"en": "URL", "ar": "العنوان"},
    ...
    "dashboard.fts5_db": {"en": "Episodes", "ar": "الحلقات"},
    "dashboard.records": {"en": "records", "ar": "سجل"},
    "dashboard.vector_store": {"en": "Beliefs", "ar": "المعتقدات"},
    ...
    "dashboard.memory_search_all": {"en": "Search all knowledge", "ar": "البحث في كل المعرفة"},
    "dashboard.memory_include_kb": {"en": "Include Knowledge Library", "ar": "تضمين مكتبة المعرفة"},
    "dashboard.memory_probe_memory": {"en": "Memory", "ar": "الذاكرة"},
    "dashboard.memory_probe_federated": {"en": "Federated", "ar": "موحّد"},
    "dashboard.memory_bitemporal": {"en": "Bi-Temporal Scrub", "ar": "فرك زمني ثنائي"},
    "dashboard.memory_bitemporal_hint": {"en": "Drag to see past states.", "ar": "اسحب لرؤية الحالات السابقة."},
    "dashboard.memory_play": {"en": "Play", "ar": "تشغيل"},
    "dashboard.memory_pause": {"en": "Pause", "ar": "إيقاف"},
    "dashboard.memory_live": {"en": "Live", "ar": "مباشر"},
    "dashboard.memory_live_now": {"en": "Live (now)", "ar": "مباشر (الآن)"},
    "settings.memory_kb_merge_title": {"en": "Knowledge + chat memory", "ar": "المعرفة + ذاكرة المحادثة"},
    ...
    "settings.memory_mode": {"en": "Mode", "ar": "الوضع"},
    "settings.memory_mode_local": {"en": "Local only", "ar": "محلي فقط"},
    "settings.memory_mode_hybrid": {"en": "Hybrid", "ar": "هجين"},
    "settings.memory_mode_remote": {"en": "Remote-first", "ar": "بعيد أولًا"},
    "settings.memory_vector_provider": {"en": "Vector provider", "ar": "مزود المتجهات"},
    "settings.memory_state_provider": {"en": "Shared state (multi-replica mirror)", "ar": "حالة مشتركة (مرآة متعددة النسخ)"},
    "settings.memory_graph_provider": {"en": "Graph store", "ar": "مخزن الرسم البياني"},
    "settings.memory_failover": {"en": "Failover if remote down", "ar": "التراجع عند تعطل البعيد"},
    "settings.memory_failover_local": {"en": "Fall back to local", "ar": "الرجوع للمحلي"},
    "settings.memory_failover_empty": {"en": "Empty results", "ar": "نتائج فارغة"},
    "settings.memory_failover_raise": {"en": "Surface error", "ar": "إظهار الخطأ"},
    "settings.memory_save_backends": {"en": "Save backends", "ar": "حفظ الخلفيات"},
    "settings.memory_test_embed": {"en": "Test embed", "ar": "اختبار التضمين"},
    "settings.memory_test_vector": {"en": "Test vector", "ar": "اختبار المتجه"},
    "settings.memory_reset_local": {"en": "Reset to local", "ar": "إعادة ضبط للمحلي"},
    "settings.memory_rebuild": {"en": "Rebuild embeddings…", "ar": "إعادة بناء التضمينات…"},
    "dashboard.memory_graph_title": {"en": "Entities", "ar": "الكيانات"},
    ...
    "dashboard.memory_legend_person": {"en": "person", "ar": "شخص"},
    "dashboard.memory_legend_chunk": {"en": "memory", "ar": "ذاكرة"},
    "dashboard.memory_legend_tag": {"en": "tag", "ar": "وسم"},
    "dashboard.memory_legend_entity": {"en": "entity", "ar": "كيان"},
    "dashboard.memory_pipe_enabled": {"en": "Memory", "ar": "الذاكرة"},
    "dashboard.memory_pipe_per_turn": {"en": "Per-turn RAG", "ar": "RAG لكل دورة"},
    "dashboard.memory_pipe_auto_store": {"en": "Auto-store", "ar": "تخزين تلقائي"},
    "dashboard.memory_pipe_consolidator": {"en": "Consolidator", "ar": "الموحّد"},
    "dashboard.memory_group_features": {"en": "Features", "ar": "الميزات"},
    "dashboard.memory_group_layers": {"en": "Memory layers", "ar": "طبقات الذاكرة"},
    "dashboard.memory_group_packages": {"en": "Packages & stores", "ar": "الحزم والمخازن"},
    "dashboard.kpi_l1_chroma": {"en": "active beliefs", "ar": "معتقدات نشطة"},
    "dashboard.kpi_l3_bm25": {"en": "active episodes", "ar": "حلقات نشطة"},
    "dashboard.kpi_l2_graph": {"en": "active entities", "ar": "كيانات نشطة"},
    "dashboard.kpi_ok": {"en": "OK", "ar": "سليم"},
    "dashboard.export": {"en": "Export", "ar": "تصدير"},
    "dashboard.comp.memory_enabled": {"en": "Memory enabled", "ar": "الذاكرة مفعّلة"},
    "dashboard.comp.per_turn_retrieval": {"en": "Per-turn retrieval", "ar": "الاسترجاع لكل دورة"},
    "dashboard.comp.auto_store": {"en": "Auto-store", "ar": "التخزين التلقائي"},
    "dashboard.comp.consolidation": {"en": "Consolidator", "ar": "الموحّد"},
    "dashboard.comp.embedder": {"en": "Embedder", "ar": "المضمّن"},
    "dashboard.comp.vector_memory": {"en": "Vector memory", "ar": "ذاكرة المتجهات"},
    "dashboard.comp.layer_l1": {"en": "L1 Chroma", "ar": "L1 كروما"},
    "dashboard.comp.layer_l2": {"en": "L2 Graph", "ar": "L2 الرسم"},
    "dashboard.comp.layer_l3": {"en": "L3 FTS5", "ar": "L3 FTS5"},
    "dashboard.comp.layer_l4": {"en": "L4 sqlite-vec", "ar": "L4 sqlite-vec"},
    "dashboard.comp.pkg_chromadb": {"en": "Package: chromadb", "ar": "حزمة: chromadb"},
    "dashboard.comp.pkg_st": {"en": "Package: sentence-transformers", "ar": "حزمة: sentence-transformers"},
    "dashboard.comp.pkg_sqlite_vec": {"en": "Package: sqlite-vec", "ar": "حزمة: sqlite-vec"},
    "dashboard.no_component_data": {"en": "No component data yet.", "ar": "لا توجد بيانات مكوّنات بعد."},
    ...
    "replay.iteration_a": {"en": "Iteration A", "ar": "التكرار أ"},
    "replay.iteration_b": {"en": "Iteration B", "ar": "التكرار ب"},

    # Voice settings
    "voice.title": {"en": "Voice Subsystem", "ar": "نظام الصوت"},
    "voice.master_help": {
    ...
    "voice.tts_reply_title": {"en": "Auto voice-note replies", "ar": "ردود صوتية تلقائية"},
    ...
    "voice.stt": {"en": "Speech-to-Text (STT)", "ar": "تحويل الكلام إلى نص (STT)"},
    "voice.tts": {"en": "Text-to-Speech (TTS)", "ar": "تحويل النص إلى كلام (TTS)"},
    "voice.stt_provider": {"en": "STT Provider", "ar": "مزوّد STT"},
    "voice.stt_model": {"en": "STT Model", "ar": "نموذج STT"},
    "voice.stt_model_loading": {"en": "(loading…)", "ar": "(جارٍ التحميل…)"},
    "voice.stt_model_custom": {"en": "Custom model ID...", "ar": "معرّف نموذج مخصص..."},
    "voice.stt_model_empty": {"en": "No models loaded — pick Custom or change provider.", "ar": "لا توجد نماذج — اختر مخصصاً أو غيّر المزوّد."},
    ...
    "voice.stt_custom_id": {"en": "Custom STT Model ID", "ar": "معرّف نموذج STT مخصص"},
    "voice.stt_custom_help": {"en": "Type any specific custom transcription model name.", "ar": "اكتب أي اسم نموذج نسخ مخصص."},
    "voice.stt_base_url": {"en": "NVIDIA ASR base URL (Speech NIM)", "ar": "عنوان ASR الأساسي (Speech NIM)"},
    "voice.stt_base_help": {
    ...
    "voice.stt_language": {"en": "STT Language", "ar": "لغة STT"},
    "voice.stt_language_help": {"en": "Use \"auto\" or ISO-639-1 format.", "ar": "استخدم \"auto\" أو صيغة ISO-639-1."},
    "voice.tts_provider": {"en": "TTS Provider", "ar": "مزوّد TTS"},
    "voice.tts_voice": {"en": "Voice Model / Voice ID", "ar": "نموذج / معرّف الصوت"},
    "voice.tts_voice_custom": {"en": "Custom voice ID...", "ar": "معرّف صوت مخصص..."},
    "voice.tts_custom_id": {"en": "Custom Voice ID", "ar": "معرّف صوت مخصص"},
    "voice.tts_custom_help": {"en": "e.g. provider voice ID, or a local file path.", "ar": "مثل معرّف صوت المزوّد أو مسار ملف محلي."},
    "voice.audio_format": {"en": "Audio Format", "ar": "صيغة الصوت"},
    "voice.format_mp3": {"en": "MP3 (standard)", "ar": "MP3 (قياسي)"},
    "voice.format_wav": {"en": "WAV (uncompressed)", "ar": "WAV (غير مضغوط)"},
    "voice.format_opus": {"en": "Opus (highly optimized)", "ar": "Opus (محسّن جداً)"},
    "voice.format_flac": {"en": "FLAC (lossless)", "ar": "FLAC (بدون فقدان)"},
    ...
    "packages.extra.dev.title": {"en": "Development", "ar": "التطوير"},
    ...
    "packages.extra.test.title": {"en": "Test", "ar": "اختبار"},
    ...
    "packages.extra.tui.title": {"en": "TUI dashboard", "ar": "لوحة TUI"},
    ...
    "packages.extra.observability.title": {"en": "Observability", "ar": "المراقبة"},
    ...
    "packages.extra.web.title": {"en": "Browser automation", "ar": "أتمتة المتصفح"},
    ...
    "packages.layer.layer_l2": {"en": "L2 Graph", "ar": "L2 الرسم"},
    "packages.layer.layer_l3": {"en": "L3 FTS5", "ar": "L3 FTS5"},
    "packages.layer.layer_l4": {"en": "L4 sqlite-vec", "ar": "L4 sqlite-vec"},
    "packages.layer.per_turn_retrieval": {"en": "Per-turn RAG", "ar": "RAG لكل دورة"},
    "packages.layer.auto_store": {"en": "Auto-store", "ar": "تخزين تلقائي"},
    "packages.layer.consolidation": {"en": "Consolidator", "ar": "الموحّد"},

    # Missing tool descriptions (registry has 95; fill gaps)
    "tool.desc.activate_skill": {"en": "Activate an installed agent skill for the session.", "ar": "تفعيل مهارة وكيل مثبتة للجلسة."},
    "tool.desc.list_agent_skills": {"en": "List installed agent skills.", "ar": "سرد مهارات الوكيل المثبتة."},
    "tool.desc.browser_navigate": {"en": "Navigate the browser to a URL.", "ar": "فتح رابط في المتصفح."},
    "tool.desc.browser_click": {"en": "Click an element in the browser.", "ar": "النقر على عنصر في المتصفح."},
    "tool.desc.browser_fill_form": {"en": "Fill form fields in the browser.", "ar": "تعبئة حقول نموذج في المتصفح."},
    "tool.desc.browser_extract_text": {"en": "Extract text from the current page.", "ar": "استخراج النص من الصفحة الحالية."},
    "tool.desc.browser_screenshot": {"en": "Capture a screenshot of the page.", "ar": "التقاط لقطة شاشة للصفحة."},
    "tool.desc.browser_eval_js": {"en": "Evaluate JavaScript in the page context.", "ar": "تنفيذ JavaScript في سياق الصفحة."},
    "tool.desc.config_read": {"en": "Read a configuration value.", "ar": "قراءة قيمة إعداد."},
    "tool.desc.config_save": {"en": "Save a configuration value.", "ar": "حفظ قيمة إعداد."},
    "tool.desc.email_list": {"en": "List emails from the mailbox.", "ar": "سرد الرسائل من صندوق البريد."},
    "tool.desc.email_get": {"en": "Get a single email by id.", "ar": "جلب رسالة بريد بمعرّفها."},
    "tool.desc.email_send": {"en": "Send an email message.", "ar": "إرسال رسالة بريد."},
    "tool.desc.email_delete": {"en": "Delete an email message.", "ar": "حذف رسالة بريد."},
    "tool.desc.email_categorize": {"en": "Categorize an email.", "ar": "تصنيف رسالة بريد."},
    "tool.desc.email_analyze": {"en": "Analyze an email for intent/summary.", "ar": "تحليل رسالة بريد للقصد/الملخص."},
    "tool.desc.list_events": {"en": "List calendar events.", "ar": "سرد أحداث التقويم."},
    "tool.desc.create_event": {"en": "Create a calendar event.", "ar": "إنشاء حدث في التقويم."},
    ...
    "tool.desc.vault_retrieve": {"en": "Retrieve a secret from the vault.", "ar": "استرجاع سر من الخزنة."},
    "tool.desc.vault_list": {"en": "List secrets in the vault (names only).", "ar": "سرد أسرار الخزنة (الأسماء فقط)."},
    "tool.desc.vault_delete": {"en": "Delete a secret from the vault.", "ar": "حذف سر من الخزنة."},
    "tool.desc.web_search_duckduckgo": {"en": "Search the web via DuckDuckGo.", "ar": "البحث في الويب عبر DuckDuckGo."},

    # Native skill descriptions
    ...
    "swarm.validation_api_error": {"en": "Validation API Error", "ar": "خطأ في واجهة التحقق"},
 ...
 "swarm.routing_diagnostics": {"en": "Unified Routing Diagnostics", "ar": "تشخيصات التوجيه الموحدة"},
    ...
    "swarm.arabic_dialect": {"en": "Arabic Dialect: ", "ar": "اللهجة العربية: "},
 ...
 "swarm.diag_yes": {"en": "YES", "ar": "نعم"},
    ...
    "swarm.edit_worker_modal": {"en": "Edit Worker", "ar": "تعديل العامل"},
 ...
 "swarm.play_hint_conditional": {"en": "Conditional: Evaluates condition to determine route.", "ar": "شرطي: يقيّم الشرط لتحديد المسار."},
    ...
    "swarm.mermaid_render_error": {"en": "Mermaid Render Error:", "ar": "خطأ في عرض Mermaid:"},
