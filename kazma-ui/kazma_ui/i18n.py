...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "memory.intro": {
        "en": "Browse beliefs and entities, merge/link isolated nodes, and run hygiene — without relying on the chat agent.",
        "ar": "تصفح المعتقدات والكيانات، ادمج/اربط العقد المعزولة، ونظّف الذاكرة — دون الاعتماد على وكيل الدردشة.",
    },
