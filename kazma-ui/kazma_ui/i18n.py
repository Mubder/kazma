...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "settings.kb_action.open_workspace": {"en": "open workspace", "ar": "فتح مساحة العمل"},
    "settings.kb_action.open_settings": {"en": "open settings", "ar": "فتح الإعدادات"},
    ...
    "settings.kb_action.focus_chat": {"en": "focus chat", "ar": "تركيز المحادثة"},
    "settings.kb_action.clear_chat": {"en": "clear chat", "ar": "مسح المحادثة"},
    "settings.kb_action.refresh": {"en": "refresh", "ar": "تحديث"},
