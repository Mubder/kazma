...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "settings.offsite_desc": {"en": "Sync every backup to your cloud storage via rclone. Protects against disk failure — without this, data and backups share one drive.", "ar": "مزامنة كل نسخة احتياطية مع التخزين السحابي عبر rclone. يحمي من فشل القرص — بدون هذا، البيانات والنسخ على قرص واحد."},
    ...
    "settings.offsite_remote": {"en": "rclone Remote Path", "ar": "مسار rclone البعيد"},
